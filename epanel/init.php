...
class WPTheme {
	...
	function theme_supports()
	{
		...
		add_image_size( 'medium-thumbnail', 456, 325, true );			// Registers a new image size.
	...
	function load_functions()
	{
		...
		// woocommerce new field
		include_once( THEME_FRAMEWORK_DIR.'functions/woocommerce_billing.php' );	
	}
