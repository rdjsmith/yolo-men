...
$.fn.storeLocator = function(options) {
  ...
  var settings = $.extend( {
      ...
      'storeLimit'    : 26,
      'distanceAlert' : 60,
      'dataLocation'  : theme_ajax.site_url + '/locations.xml',
      'listColor1'    : 'ffffff',
      'listColor2'    : 'eeeeee',
      'bounceMarker'  : true,
      'slideMap'      : true,
        ...
        success: function(data) {
            ...
            else
            {
              ...
              $(data).find('marker').each(function(){
                ...
                var phone = ($(this).attr('phone')) ? $(this).attr('phone') : ''; 
                var web = ($(this).attr('web')) ? $(this).attr('web') : ''; 
                //web = web.replace("http://","oc.imglabs.com/partystarshots/v2.0.3");
          ...
          $(function(){ 
              ...
              function create_store_variables(loopcount)
              {
				...
				/*
				storePhone = (typeof locationset[loopcount][9] != 'undefinded') ? locationset[loopcount][9] : '';
